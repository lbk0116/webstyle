 ...
 $(document).ready(function(){
     ...
     function addSearchKey(){
         var $div=$('<div class="col-md-12">'+
                 ...
                 '<ul data-tag="certificate_ids"><li>证书：</li><li><a href="cisco">Cisco</a></li><li><a href="华为">华为</a></li><li><a href="华三">华三</a></li><li><a href="F5">F5</a></li><li><a href="IBM">IBM</a></li></ul>'+
         ...
         $("div.col-md-12>ul>li>a").click(function(e){
             ...
             if(liActive){
                 ...
                 }else if(tag==="certificate_ids"){
                    if(indexObj.certificate_ids){
                        removeSelect(indexObj.certificate_ids);
                    }
                     ...
                     $("form button.oe_apply:first").trigger("submit");
                     var divNum=$(".oe_searchview_facets div").length;
                     indexObj.certificate_ids=divNum-2;
